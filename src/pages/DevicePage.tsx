...
const DevicePage = () => {
  ...
  return (
    <div className="relative w-full h-full">
      ...
      {createExplainingDiv('blue', String(data.tempWoter), 'Вода', { top: 70, left: 84 }, helpM.temp_water_m)}
      {createExplainingDiv('red', String(data.tempDef), 'Дефлагматор', { top: 58, left: 816.5 }, helpM.temp_defl_m)}
      {createExplainingDiv('orange', String(data.tempCargi), 'Царга', { top: 271, left: 827 }, helpM.temp_cargi_m)}
      {createExplainingDiv('purple', String(data.tempCube), 'Куб', { top: 529, left: 860 }, helpM.temp_cube_m)}
      <p
