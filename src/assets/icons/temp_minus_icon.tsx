...
const TempMIcon: React.FC<SVGProps<SVGSVGElement>> = (props) => {
    ...
    return (
        ...
        fill="none"
        >
            <g clip-path="url(#clip0_157_1194)">
            ...
            <path d="M8 9H12" stroke={props.color || "white"} strokeWidth="2" strokeLinecap="round" stroke-linejoin="round"/>
            <path d="M16 9H22" stroke={props.color || "white"} strokeWidth="2" strokeLinecap="round" stroke-linejoin="round"/>
            </g>
            <defs>
            <clipPath id="clip0_157_1194">
