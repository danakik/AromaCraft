...
const store = configureStore({
  ...
  middleware: (getDefaultMiddleware) =>
    getDefaultMiddleware().concat(samogonApi.middleware, loginApi.middleware, mainApi.middleware,  createRoomApi.middleware, saveRoomApi.middleware, deleteRoomApi.middleware),
});
