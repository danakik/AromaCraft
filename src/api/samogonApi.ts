    ...
    getData: builder.query<SortedData, string>({
      ...
      transformResponse: (response: string): SortedData => {
        ...
        return {
          ...
          rectPercentBody: parseNumber(data[21]),
          rectDecreaseTemp: parseNumber(data[102]),
          rectDecreaseSpeed: parseNumber(data[103]),
          ...
          rectCyclesNumber: parseNumber(data[135]),
          rectEndCycle: parseNumber(data[34]),
