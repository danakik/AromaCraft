...
export const gist_selection_m =
  'Температурний діапазон, де працює основний клапан відбору. При досягненні температури відбору клапан припинить відбір, при падінні температури на величину гістерезису відбір буде відновлений.';
