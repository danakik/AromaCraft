  ...
  return (
    <div className="flex flex-wrap gap-3 justify-content-center align-items-center flex flex-vertical-center">
      ...
      <div className="custom-input">
        <InputNumber suffix={units} value={count} onChange={handleInputChange} min={min} max={max} step={step} />
      </div>
...
export const ACCounterLabel: React.FC<CounterProps2> = ({ value, units, label, help, onChange }) => {
  ...
  return (
    <div className="flex label-container">
      <p className="label" onClick={handleLabelClick} style={{ cursor: 'pointer' }}>
        {label}
      </p>
      <div className="flex flex-wrap gap-3 justify-content-center align-items-center flex flex-vertical-center">
        <Button icon="pi pi-minus" className="custom-button" onClick={handleDecrement} />
