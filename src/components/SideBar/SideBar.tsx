...
export const SideBar = (props: PanelMenuProps) => {
    ...
    const homeIcon = useMemo(() => HomeIcon({ width: 22, height: 23, viewBox: '0 0 22 23', fill: 'none', xmlns: 'http://www.w3.org/2000/svg', color: 'white' }), []);
    const exitIcon = useMemo(() => ExitIcon({ width: 16, height: 16, viewBox: '0 0 16 16', xmlns: 'http://www.w3.org/2000/svg' }), []);
    const processIcon = useMemo(() => ProcessIcon({ width: 20, height: 20, viewBox: '0 0 20 20', fill: 'none', xmlns: 'http://www.w3.org/2000/svg', color: 'white' }), []);
    const dataIcon = useMemo(() => DataIcon({ width: 18, height: 22, viewBox: '0 0 18 22', xmlns: 'http://www.w3.org/2000/svg' }), []);
    const settingsIcon = useMemo(() => SettingsIcon({ width: 22, height: 22, viewBox: '0 0 22 22', xmlns: 'http://www.w3.org/2000/svg', color: 'white' }), []);
    ...
    useEffect(() => {
        ...
        if (location.pathname.startsWith('/manualprocess') || 
        ...
        if (location.pathname.startsWith('/datatemperatures') || 
            location.pathname.startsWith('/datastatistics')) {
